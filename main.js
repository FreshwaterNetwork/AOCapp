...
function ( 	declare, PluginBase, ContentPane, dom, domStyle, domGeom, obj, content, esriapi, clicks, lang ) {
	return declare(PluginBase, {
		...
		hasCustomPrint: false, size:'custom', width:470, 
		...
		initialize: function (frameworkParameters) {
			...
			this.url = "https://cirrus-web-adapter-241060755.us-west-1.elb.amazonaws.com/arcgis/rest/services/FN_Wisconsin/LowerFox_AOC/MapServer";
			this.layerDefs = [];
		},
